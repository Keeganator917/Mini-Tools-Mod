...
import keeganator.minitools.item.custom.EnderSlayerSword;
import keeganator.minitools.item.custom.RockItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Properties, Item> function) {
        return Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MiniTools.MOD_ID, name),
                function.apply(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(MiniTools.MOD_ID, name)))));
    }
